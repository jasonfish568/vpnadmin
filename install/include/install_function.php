...
<div class="container">
	<div class="header">
		<h1>$title</h1>
		<span>VPN Admin $version $install_lang $release</span>
EOT;
...
function show_footer($quit = true) {
	...
	echo <<<EOT
		<div class="footer">&copy;2013 <a href="http://vpn.euclan.com/">VPN.EUCLAN.COM</a></div>
	</div>
</div>
</body>
</html>
...
function save_vpnconfig_file($filename, $dbhost, $dbname,$dbpw,$dbuser) {
