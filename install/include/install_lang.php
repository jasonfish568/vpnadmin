...
$lang = array(
	...
	'tablepre_comment' => '同一数据库运行多个管理系统时，请修改前缀',
	...
	'install_dzfull' => '<br><label><input type="radio"'.(getgpc('install_ucenter') != 'no' ? ' checked="checked"' : '').' name="install_ucenter" value="yes" onclick="if(this.checked)$(\'form_items_2\').style.display=\'none\';" /> 全新安装 VPN ADMIN 1.0</label>',
...
<p>版权所有 (c) 2013，VPN.EUCLAN.COM</p>
