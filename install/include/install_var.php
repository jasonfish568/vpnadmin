...
if(!defined('DISCUZ_VERSION')) {
	define('DISCUZ_VERSION', '1.0');
	define('DISCUZ_RELEASE', '20130913');
...
define('CONFIG', './data/config_global.php');

$_config = array();

$_config['db'][1]['dbhost']  		= 'localhost';
$_config['db'][1]['dbuser']  		= 'root';
$_config['db'][1]['dbpw'] 	 	= 'rootpw';
$_config['db'][1]['dbcharset'] 		= 'gbk';
$_config['db'][1]['pconnect'] 		= 0;
$_config['db'][1]['dbname']  		= 'vpnadmin';
...
(
	...
	'ajax' => array('type' => 'dir', 'path' => './ajax'),
	'css' => array('type' => 'dir', 'path' => './css'),
	'data' => array('type' => 'dir', 'path' => './data'),
	'doc' => array('type' => 'dir', 'path' => './doc'),
	'img' => array('type' => 'dir', 'path' => './img'),
	'js' => array('type' => 'dir', 'path' => './js'),
	'setting' => array('type' => 'dir', 'path' => './setting'),
